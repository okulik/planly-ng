...
ActiveRecord::Schema.define(version: 20150219074633) do
  ...
  create_table "trips", force: :cascade do |t|
    ...
    t.integer  "user_id"
    t.uuid     "tid",         default: "uuid_generate_v4()"
  end
  ...
  add_index "trips", ["tid"], name: "index_trips_on_tid", unique: true, using: :btree
